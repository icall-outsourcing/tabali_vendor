...
<div class="box-body" style="display: block;">
  ...
  <div class="remotearea form-group col-md-8">
    <label><?php echo e(trans('form.area')); ?></label>
    <div id="remote" class="input-group">
        <input class="form-control Typeahead-input"  id="Typeahead-input" type="text" name="area" placeholder="Search" autocomplete="off" spellcheck="false" dir="rtl">
  ...
  <input class="Append" type="hidden" id="account_id" name="account_id" value="<?php echo e($accountId); ?>">
    ...
    jQuery(document).ready(function($) {     
        // Set the Options for "Bloodhound" suggestion engine
         var engine = new Bloodhound({
            remote: {
                url     :"<?php echo e(url('Address/find/%QUERY%')); ?>",
                wildcard: '%QUERY%'
            },
