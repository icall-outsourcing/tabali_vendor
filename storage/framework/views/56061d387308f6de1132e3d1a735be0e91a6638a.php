                ...
                <script>
                    ...
                    $(document).on('click','#checkVoucher',function(){
                        ...
                        if (voucher == null || voucher == 0) {
                            ...
                            currentRequest = $.ajax({
                                url     :"<?php echo e(url('Voucher')); ?>/"+voucher,                                
                                dataType:'json',
                                type    :'get',
            ...
            <?php echo Form::model('Order',['data-toggle'=>'validator','id'=>'myForm','role'=>'form','method'=>'POST','enctype' =>'multipart/form-data','route'=>"Order.store"]); ?>
                ...
                <div class="col-md-6">
                      <div class="box box-default" id="ordertabel">
                            ...
                            <div class="form-group">
                                <label>المصدر</label>
                                <?php echo Form::select('source',array('Phone'=>'Phone','Otlob'=>'Otlob','El menus'=>'El menus','Koinz'=>'Koinz','Marsool'=>'Marsool','Botit'=>'Botit','Online'=>'Online'),null,['class' => 'form-control select2','id' => 'source']); ?>
                        ...
                        <div class="box-body table-responsive no-padding">
                          <table class="table table-hovered">
                            ...
                            <tfoot class="label-success">
                                <tr style="width: 100%">
                                    <th style="width: 30%"><?php echo e(trans('form.totalprice')); ?></th>
				    <th style="width: 40%"><span class="label label-danger"><strong id="totalinvoice">0</strong></span></th>                                                                                    
				    <th colspan="4" style="width:20% "><?php echo e(trans('form.deliveryTime')); ?></th>
                                    <th><span class="label label-danger"><strong> <?php echo e($area->dlivery_time); ?> M </strong></span></th>
                                </tr>
                                ...
                                <tr style="width: 100%" >
                                    ...
                                    <input type="hidden" name="deliveryfees" id="fess" value=" <?php if(empty($area)): ?> 0 <?php else: ?> <?php echo e($area->dlivery_fees); ?> <?php endif; ?> "><span class="label label-danger" id="deliveryfees"><strong><?php if(!empty($area)): ?> <?php echo e($area->dlivery_fees); ?> <?php else: ?> 0 <?php endif; ?></strong></span></th>                                    
                                    <th style="border:none !important;"></th>
                                    <th style="border:none !important;"></th>
                                    <th style="border:none !important;"></th>
                                    <th style="border:none !important;"></th>
