  ...
  <div class="box-body" style="display: block;">
    ...
    <div class="remotearea form-group col-md-8">
      ...
      <div id="remote" class="input-group">
          <input class="form-control Typeahead-input"  id="Typeahead-input" type="text" name="area" placeholder="<?php if(!empty($getArea->name)): ?>  <?php echo e($getArea->name); ?> <?php endif; ?>" autocomplete="off" spellcheck="false" dir="rtl" >
