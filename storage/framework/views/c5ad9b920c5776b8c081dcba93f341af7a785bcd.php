...
<?php $__env->startSection('content'); ?>
    ...
    <div class="Append roles_list col-md-4">
        <div class="form-group">
          ...
          <?php echo Form::select("roles_list[]",$roles ,null,["class" => "form-control select2","id" => "role","required" =>"required",'multiple'=>'multiple',"style"=>"width:100%"]); ?>
    ...
    <div class="Append permissions_list col-md-4">
        <div class="form-group">
          ...
          <?php echo Form::select("permissions_list[]",$permissions ,null,["class" => "form-control select2","id" => "permissions","required" =>"required",'multiple'=>'multiple',"style"=>"width:100%"]); ?>
